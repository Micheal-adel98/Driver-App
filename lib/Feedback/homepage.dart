                          ...
                          child: Container(child: Align(
                            ...
                            child: RaisedButton(
                              ...
                              onPressed: () async{
                                ...
                                await Firestore.instance.collection('Drivers').document(widget.uid).collection('Feedback').document().setData({"Student": value});
                               await Firestore.instance.collection('Drivers').document(widget.uid).updateData({"Rate": sum});
